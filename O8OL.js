...
let practice={
  type:jsPsychHtmlKeyboardResponse,
  timeline:[
   {stimulus:`<p style="color:red;font-weight:bold;font-size:120px;">红</p>`,choices:['f','j'],on_finishi:function(data){
      fail=data.response==='j';}
    },
    {
timeline:[
  {
    stimulus:'按空格键开始练习',chioces:[' '],
  }
],
...
jsPsych.run([trial1,trial2, trials,endtrial]);
